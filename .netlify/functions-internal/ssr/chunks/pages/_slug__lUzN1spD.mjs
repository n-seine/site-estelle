...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="fr"> <head>${renderComponent($$result, "SEO", $$SEO, { "title": title, "titleDefault": "Estelle Chauvard : Autrice / Vid\xE9aste / Graphiste", "description": "Le portfolio d'Estelle Chauvard, autrice, vid\xE9aste et graphiste \xE0 Paris, \xE0 l'origine du travail sur la m\xE9moire de Danielle Dixe \xE0 Lagrasse", "canonical": "https://estelle-chauvard.com", "openGraph": {
    basic: {
      ...
      image: "https://i.ibb.co/0DnZzVb/estelle-chauvard.jpg",
      type: "website",
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  let content;
  {
    ...
    data.stories[projectIndex - 1].full_slug || data.stories[data.stories.length - 1].full_slug;
  }
  const altLayout = content.content.details[0].alternativeLayout;
  return renderTemplate`${renderComponent($$result, "PagesLayout", $$PagesLayout, { "title": "Estelle Chauvard - " + content.name }, mergeSlots({}, altLayout ? { "default": () => renderTemplate`${renderComponent($$result, "AltProjectLayout", $$AltProjectLayout, { "story": content })}` } : { "default": () => renderTemplate`${renderComponent($$result, "ProjectLayout", $$ProjectLayout, { "story": content })}` }))}`;

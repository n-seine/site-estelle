...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "PagesLayout", $$PagesLayout, { "title": "Estelle Chauvard - " + retrievedProject.name }, mergeSlots({}, altLayout ? { "default": () => renderTemplate`${renderComponent($$result, "AltProjectLayout", $$AltProjectLayout, { "story": retrievedProject })}` } : { "default": () => renderTemplate`${renderComponent($$result, "ProjectLayout", $$ProjectLayout, { "story": retrievedProject })}` }))} 
---`;
